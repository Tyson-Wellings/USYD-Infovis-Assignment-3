...
with open('blue_vectors.csv') as vector_data:
    ...
    clusters = KMeans(random_state=1 ,n_clusters=20,n_init=20).fit_predict(training_data) #run kmeans


    with open('tsne_blue.csv', mode='w', newline="") as output_file:
